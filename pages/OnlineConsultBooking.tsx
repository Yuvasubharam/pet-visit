...
const OnlineConsultBooking: React.FC<Props> = ({ pets, onBack, onBook, userId, onProceedToCheckout }) => {
  ...
  const loadDoctors = async () => {
    try {
      ...
      console.log('[OnlineConsultBooking] Loading doctors for:', { dateStr });
      ...
      <div className="fixed bottom-0 left-0 right-0 max-w-md mx-auto p-6 bg-white/95 backdrop-blur-xl border-t border-gray-100 z-40 shadow-[0_-10px_40px_rgba(0,0,0,0.05)]">
        <div className="flex items-center justify-between gap-6">
          <div className="flex flex-col">
            <span className="text-[10px] font-black text-gray-400 uppercase tracking-widest leading-none mb-1">Total Amount (incl. fees)</span>
